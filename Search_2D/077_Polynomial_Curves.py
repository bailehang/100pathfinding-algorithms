...
class PolynomialCurves:
    ...
    def run_demonstration(self):
        ...
        self.draw_base("072 Polynomial Curves - Grid Search")
        if self.visited:
            plt.scatter(
        ...
        self.draw_base("072 Polynomial Curves - A* Waypoint Path")
        if self.raw_path:
            plt.plot(
        ...
        self.draw_base("072 Polynomial Curves - Safe Waypoints")
        if self.raw_path:
            plt.plot(
                [p[0] for p in self.raw_path],
                [p[1] for p in self.raw_path],
        ...
        for i in range(1, frame_count + 1):
            ...
            self.draw_base("072 Polynomial Curves - Cubic Trajectory")
            plt.plot(
                [p[0] for p in self.waypoints],
                [p[1] for p in self.waypoints],
                "o--",
        ...
        self.save_gif("077_Polynomial_Curves", fps=4)
        plt.close("all")
