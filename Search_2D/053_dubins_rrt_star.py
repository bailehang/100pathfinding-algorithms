...
class RRTDubinsPlanner:
    ...
    def planning(self, save_gif=False, gif_name="053_dubins_rrt"):
    ...
    def render_snapshot(self, snapshot):
        ...
        ax.set_xticks([])
        ax.set_yticks([])
        ax.set_title("053 RRT-Dubins - bounded curvature states")
...
def main():
    ...
    path = planner.planning(save_gif=True, gif_name="053_dubins_rrt")
    if not path:
