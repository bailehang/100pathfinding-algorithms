...
class DynamicRRTPlanner:
    ...
    def planning(self, save_gif=False, gif_name="051_dynamic_rrt"):
    ...
    def render_snapshot(self, snapshot):
        ...
        ax.set_xticks([])
        ax.set_yticks([])
        ax.set_title("051 Dynamic RRT - trim and repair")
...
def main():
    ...
    path = planner.planning(save_gif=True, gif_name="051_dynamic_rrt")
    if not path:
