...
class RandomPathPlanner:
    ...
    def planning(self, save_gif=False, gif_name="048_random_path_planning"):
    ...
    def render_snapshot(self, snapshot):
        ...
        ax.set_xticks([])
        ax.set_yticks([])
        ax.set_title("048 Random Path Planning - random visibility roadmap")
...
def main():
    ...
    path = planner.planning(save_gif=True, gif_name="048_random_path_planning")
    if not path:
