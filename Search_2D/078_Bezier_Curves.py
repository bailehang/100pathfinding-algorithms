...
class BezierCurves:
    ...
    def run_demonstration(self):
        ...
        self.draw_base("073 Bezier Curves - Grid Search")
        if self.visited:
            plt.scatter(
        ...
        self.draw_base("073 Bezier Curves - Safe Waypoints")
        plt.plot(
        ...
        self.draw_base("073 Bezier Curves - Control Polygons")
        ...
        for i in range(1, frame_count + 1):
            ...
            self.draw_base("073 Bezier Curves - Cubic Bezier Trajectory")
            for controls in self.control_polygons:
                plt.plot(
                    [p[0] for p in controls],
                    [p[1] for p in controls],
        ...
        self.save_gif("078_Bezier_Curves", fps=4)
        plt.close("all")
