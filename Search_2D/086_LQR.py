...
class LQRPathFollower(ReferencePathFollower):
    def __init__(self, s_start=(5, 5), s_goal=(45, 25)):
        ...
        self.frame_title = "086 LQR - Optimal Feedback Path Following"
    ...
    def run_demonstration(self):
        ...
        self.draw_search_frame("086 LQR - Reference Path", self.visited, self.raw_path)
