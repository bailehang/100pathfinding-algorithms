...
_BIT_STAR_PATH = os.path.join(os.path.dirname(__file__), "059_bit_star.py")
...
class AITStar(BitStar):
    ...
    def planning(self, save_gif=False, gif_name="061_AIT_star"):
    ...
    def render_snapshot(self, snapshot):
        ...
        ax.set_xticks([])
        ax.set_yticks([])
        ax.set_title("056 AIT* - reverse adaptive heuristic and forward search")
