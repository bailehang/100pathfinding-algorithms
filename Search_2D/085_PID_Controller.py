...
class PIDControllerPathFollower(GridCurveDemo):
    ...
    def run_demonstration(self):
        ...
        self.draw_search_frame("085 PID Controller - Reference Path", self.visited, self.raw_path)
        ...
        for frame_index in frame_indices:
            ...
            self.draw_base("085 PID Controller - Path Following")
            plt.plot(
        ...
        self.save_gif("085_PID_Controller", fps=5)
        plt.close("all")
