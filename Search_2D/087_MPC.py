...
class MPCPathFollower(ReferencePathFollower):
    def __init__(self, s_start=(5, 5), s_goal=(45, 25)):
        ...
        self.frame_title = "087 MPC - Receding Horizon Path Following"
        self.dt = 0.18
        self.speed = 1.65
        self.lookahead = 2.5
        self.horizon = 12
    ...
    def run_demonstration(self):
        ...
        self.draw_search_frame("087 MPC - Reference Path", self.visited, self.raw_path)
