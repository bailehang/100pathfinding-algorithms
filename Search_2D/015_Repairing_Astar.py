...
class RepairingAStar:
    ...
    def run_demonstration(self):
        ...
        # Save the GIF
        self.Plot.save_animation_as_gif("015_Repairing_Astar_Modified", fps=2)
    ...
    def run_obstacle_removal_demonstration(self):
        ...
        # Save the GIF
        self.Plot.save_animation_as_gif("015_Repairing_Astar_Obstacle_Removal", fps=2)
    ...
    def run_complete_demonstration(self):
        ...
        self.Plot.save_animation_as_gif("015_Repairing_Astar_Complete", fps=2)
